...
const newFoodRouter = express.Router({ mergeParams: true })

newFoodRouter.get('/', getFoodsByDogId)
newFoodRouter.post('/', validateFoodInfo, createFood)

module.exports = newFoodRouter
